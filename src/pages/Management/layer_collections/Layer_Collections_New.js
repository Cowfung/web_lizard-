        ...
        <Fragment>
            ...
            <div className="khuon_management">
                <div className="duongdan">
                    ...
                    <Link className='a_management' to='/layer_collections'>LAYERS COLLECIONS</Link> {'>'} NEW
                </div>
                <div className="list">
                    <div className="list1">
                        <Link to="/layer_collections"><div><i style={{ color: '#008080' }} className="fa-solid fa-arrow-left fa-2xl" /></div></Link>
                        <div className="logouser">
                            <img src="../../../assets/img/raster.png" alt="" />
                            <p style={{ fontWeight: 'bold', width: '200px' }}>LAYERS COLLECTIONS</p>
                        </div>
                        <div style={{ marginLeft: '70px' }} className="noidung">
                            <p style={{ paddingTop: '10px' }}>Layers collections management.</p>
                        </div>
                    </div>
                    <div className="list3">
                        <div className="wms_new">
                            <form>
                                ...
                                <div className="nutsubmit" style={{ display: 'flex', justifyContent: 'space-between', width: '1100px' }}>
                                    <Link to="/layer_collections"><button type="button" style={{ backgroundColor: 'white', width: '100px' }}>CANCEL</button></Link>
