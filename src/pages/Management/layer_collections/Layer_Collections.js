...
function Collections() {
    const baseURL = "https://demo.lizard.net/api/v4/layercollections";
        ...
        <Fragment>
            ...
            <div className="khuon_management">
                <div className="duongdan">
                    ...
                    <Link className='a_management' to='/management_data'>DATA MANAGEMNT</Link> {'>'} LAYER COLLECTIONS
                </div>
                <div className="list">
                    <div className="list1">
                        ...
                        <div className="logouser">
                            ...
                            <p style={{ fontWeight: 'bold', width: '180px' }}>LAYER COLLECIONS</p>
                        </div>
                        <div style={{ marginLeft: '70px' }} className="noidung">
                            <p style={{ paddingTop: '10px' }}>List of layer collections.
                            </p></div>
                    </div>
                    <div className="list2">
                        <div className="noidung2">
                            ...
                            <div>
                                <div id="form">
                                    <Link to="/layer_collections_new"><button style={{ backgroundColor: '#0080809c', width: '150px', height: '30px', borderRadius: '4px' }}>+NEW ITEM</button></Link>
                                </div>
                            ...
                            <table>
                                <thead>
                                    <tr><th><input type="checkbox" /></th>
                                        <th className="username">Slug<i className="bi bi-arrows-expand" /></th>
