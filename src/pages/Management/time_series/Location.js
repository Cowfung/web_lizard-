...
function Location() {
    const baseURL = "https://demo.lizard.net/api/v4/locations";
        ...
        <Fragment>
            ...
            <div className="khuon_management">
                <div className="duongdan">
                    ...
                    <Link className='a_management' to='/time_series_home'>TIME SERIES</Link> {'>'} LOCATION
                </div>
                <div className="list">
                    <div className="list1">
                        ...
                        <div className="logouser">
                            ...
                            <p style={{ fontWeight: 'bold', width: '180px' }}>LOCATIONS</p>
                        </div>
                        <div style={{ marginLeft: '70px' }} className="noidung">
                            <p style={{ paddingTop: '10px' }}>Search or sort your locations here.<br />Check out possible actions by clicking the three dots icon.<br />Create a new oject with the New item button on the top right corner.
                            </p></div>
                    </div>
                    <div className="list2">
                        <div className="noidung2">
                            ...
                            <div>
                                <div id="form">
                                    <Link to="/location_new"><button style={{ backgroundColor: '#0080809c', width: '150px', height: '30px', borderRadius: '4px' }}>+NEW ITEM</button></Link>
                                </div>
                            ...
                            <table>
                                <thead>
                                    <tr><th><input type="checkbox" /></th>
                                        ...
                                        <th style={{ width: '400px' }} className="Temporal">Code</th>
                                        <th style={{ width: '500px' }}>Acessibility</th>
