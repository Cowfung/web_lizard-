...
function NetWork() {
    const baseURL = "https://demo.lizard.net/api/v4/monitoringnetworks?_limit=10";
        ...
        <Fragment>
            ...
            <div className="khuon_management">
                <div className="duongdan">
                    ...
                    <Link className='a_management' to='/time_series_home'>TIME SERIES</Link> {'>'} MONITORING NETWORKS
                </div>
                <div className="list">
                    <div className="list1">
                        ...
                        <div className="logouser">
                            ...
                            <p style={{ fontWeight: 'bold', width: '180px' }}>MONITORING NETWORKS</p>
                        </div>
                        <div style={{ marginLeft: '70px' }} className="noidung">
                            <p style={{ paddingTop: '10px' }}>Monitoring networks are used to group and give insights on time series. Check out possible actions by clicking the three dots icon next to existing networks.

                                <br />Create a new object with the New Item button on the top right corner.
                            </p></div>
                    </div>
                    <div className="list2">
                        <div className="noidung2">
                            ...
                            <div>
                                <div id="form">
                                    <Link to="/net_work_new"><button style={{ backgroundColor: '#0080809c', width: '150px', height: '30px', borderRadius: '4px' }}>+NEW ITEM</button></Link>
                                </div>
